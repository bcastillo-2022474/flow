    ...
    import {setCurrentColumnId, setIsInputTaskOpen} from "../../redux/slices/newTaskStatusSlice.ts";
    ...
    const ColumnComponent = ({column: {id, name, color}}: { column: Column }) => {
        ...
        const {currentColumnId, isInputTaskOpen} = useSelector((state: RootState) => state.newTaskStatus);
